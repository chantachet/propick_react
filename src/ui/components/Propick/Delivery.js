...
export default class Delivery extends Component {
    ...
    handleFormSubmit = async (event) => {
        ...
        this.setState({
            ...
            // isCalculate: true,
            isRenderSearch: false,
            // latFrom: 13.7646624, lngFrom: 100.64343459999998,
            // latTo: 13.8263031, lngTo: 100.67894260000003
        })
            ...
            <div id="delivery">
                <div className="row">
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-6">
                        {/* <div className="deliveryCalculate-info" style={{ backgroundImage: 'url(' + calulateBg + ')' }}> */}
                        <div className="row">
